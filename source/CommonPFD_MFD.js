...
class PFD_CDI extends NavSystemElement {
    ...
    onUpdate(_deltaTime) {
        ...
        diffAndSetAttribute(this.cdi, "active", SimVar.GetSimVarValue("HSI CDI NEEDLE VALID", "Bool") ? "True" : "False");
        diffAndSetAttribute(this.cdi, "scale", SimVar.GetSimVarValue("GPS CDI SCALING", "nautical mile"));
        diffAndSetAttribute(this.cdi, "gpsxtk", SimVar.GetSimVarValue("GPS WP CROSS TRK", "nautical mile"));
    }
    onExit() {
    }
    onEvent(_event) {
